...
書籍「**[現場で使えるGo言語実践テクニック: 設計パターン・並行処理・パフォーマンス最適化](https://www.amazon.co.jp/dp/B0GQL8VS7Q)**」（森川 陽介 著）のサンプルコード集です。
...
- **著者**: 森川 陽介
- **Amazon**: [Kindleで購入](https://www.amazon.co.jp/dp/B0GQL8VS7Q)
